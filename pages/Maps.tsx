...
export const MapsPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">{t('maps')}</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card title={t('mapConfiguration')}>
                    <div className="space-y-4">
                        ...
                        >
                            <Save size={18} /> {t('updateMap')}
                        </button>
                    </div>
                </Card>

                <Card title={t('livePreview')} className="h-full min-h-[400px]">
