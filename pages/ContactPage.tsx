            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card title="Update Contact Details">
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                <MapPin size={14} className="inline mr-1" /> Physical Address
                            </label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                <Globe size={14} className="inline mr-1" /> Geo Location (Lat, Long)
                            </label>
                            <input type="text" className="w-full p-2 rounded-lg border dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                ...
                <Card title="Preview">
                    <div className="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-lg space-y-4">
                        <h3 className="font-bold text-lg text-gray-800 dark:text-white border-b pb-2">Contact Us</h3>
